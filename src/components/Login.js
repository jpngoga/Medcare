...
const Login = () => {
  return (
    ...
    <div className='Login-container' style={{textAlign:"center",}}>
            <h3 style={{fontWeight:"350",textAlign:"left"}}>Login with Your account</h3>
          <br></br>
          <br></br>
          ...
          <div  style={{  backgroundColor:"#101727",padding:"8px",border:"none", borderRadius:"10px",width:"300px"}}>
            <button  style={{ backgroundColor:"#101727",color:"white", border:"none", borderRadius:"10px"}}>Login</button>
          </div>
          ...
          <BsGoogle/>
          <button style={{ backgroundColor:"lightgray",padding:"8px",border:"none", borderRadius:"10px"}}>Login with Google</button>

          </div>
          <br/>
          <div>
          <p style={{textAlign:"left",fontSize:"12px"}}>if you don't have an account?<span style={{fontWeigh:"bold",fontSize:"16px"}}> <Link to="/profile/create">Create an account</Link></span></p>
          </div>
